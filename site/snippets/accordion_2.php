<section class="accordion-container">
    ...
    <label for="ac-0">I work<i></i></label>
    <article class="ac-small-0">
    ...
    <label for="ac-1">in<i></i></label>
    <article class="ac-small-1">
        <p>Like you, I used to think the world was this great place where everybody lived by the same standards I did,
            ...
            then you're gonna have to pay the price. </p>
    </article>
    <input id="ac-2" name="accordion-2" type="checkbox"/>
    <label for="ac-2">FF / Chrome<i></i></label>
    <article class="ac-small-2">
    ...
    <label for="ac-3">and IE 11<i></i></label>
    <article class="ac-small-3">
        <p>You see? It's curious. Ted did figure it out - time travel. And when we get back, we gonna tell everyone. How
            ...
            spacecraft encounters a black hole does the computer call it an 'unknown entry event'? Why don't they know?
            If they don't know, that means we never told anyone. And if we never told anyone it means we never made it
